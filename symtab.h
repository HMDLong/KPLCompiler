...
enum TypeClass {
  // keep the order of numeric tp, use it for casting
  // higher type can cast to lower but not the other way
...
Type* makeStringType(void); // mo rong
Type* makeDoubleType(void); // mo rong 
...
ConstantValue* makeStringConstant(char* str); // mo rong
ConstantValue* makeDoubleConstant(double d); // mo rong
