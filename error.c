...
struct ErrorMessage errors[NUM_OF_ERRORS] = {
  ...
  {ERR_PARAMETERS_ARGUMENTS_INCONSISTENCY, "The arguments and the parameters are inconsistent."},
  // mo rong
  {ERR_INVALID_STRING, "Invalid string."},
  {ERR_INVALID_DOUBLE, "Invalid double."},
  {ERR_INVALID_NUMERIC_TYPE, "Invalid numeric type"},
  {ERR_INCOMPATIBLE_TYPE, "Incompatible type"},
  {ERR_ASSIGN_INCONSISTENCY, "Inconsistent number of elements in assign statement"},
  {ERR_INVALID_INT, "An integer expected."},
  {ERR_INVALID_CHAR, "A character expected."},
  {ERR_INVALID_ARRAY, "An array expected."},
  {ERR_UNADDABLE_TYPE, "Unaddable type. Expected: string, double, integer."},
  {ERR_INVALID_POWER, "Incompatible type for power. Expected: double, integer."},
  {ERR_INVALID_FACTORIAL, "Incompatible type for factorial. Expected: integer."}
};
